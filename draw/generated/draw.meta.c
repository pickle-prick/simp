...
internal Vec2F32                    dr_push_viewport(Vec2F32 v) {DR_StackPushImpl(Viewport, viewport, Vec2F32, v);}
...
internal Vec2F32                    dr_pop_viewport(void) {DR_StackPopImpl(Viewport, viewport, Vec2F32);}
...
internal Vec2F32                    dr_top_viewport(void) {DR_StackTopImpl(Viewport, viewport, Vec2F32);}
